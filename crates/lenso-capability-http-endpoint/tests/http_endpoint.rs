...
use lenso_capability_http_endpoint::{
    Bytes, DescribeRequest, EndpointHandleInvocationError, EndpointProvider, HandleError,
    HandleRequest, HandleResponse, HandleResponseHeadersItem, HttpEndpoint, http_endpoint,
};
